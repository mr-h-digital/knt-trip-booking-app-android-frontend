...
// Light mode: white/light-grey screen background, dark navy cards/surfaces, white text on cards.
// logoBg = Transparent is the KntCard dark-surface sentinel — same as dark mode.
val LightAppColors = AppColors(
    bgDeep           = Color(0xFFFFFFFF),   // screen background — pure white
    bgGradientTop    = Color(0xFFFFFFFF),
    bgGradientMid    = Color(0xFFF4F6F8),   // very subtle off-white mid
    bgGradientBottom = Color(0xFFEFF1F3),   // barely-there warm grey at bottom
    surface1         = Color(0xFF0A1E35),   // dark navy — same as dark mode cards
    ...
    textDim          = Color(0xFF4A6A80),
    borderColor      = KntBorder,
    navBackground    = Color(0xFF071828),   // dark nav bar matches dark cards
    headerStart      = Color(0xFF0D3060),
    headerEnd        = Color(0xFF1A5A9A),
    headerText       = KntWhite,
    headerTextMuted  = Color(0xFFB0D4EE),
    logoBg           = Color.Transparent,   // sentinel: use dark surface path in KntCard
    yellow           = KntYellow,
    blue             = KntBlue,
    blueBright       = KntBlueBright,
    orange           = KntOrange,
