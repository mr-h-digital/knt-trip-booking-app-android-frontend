...
object SampleData {
    ...
    val driverTrips = listOf(
        TripBooking(
            id = "dt1", commuterId = "u1", commuterName = "Tayla Hendricks",
        ...
        TripBooking(
            id = "dt2", commuterId = "u2", commuterName = "Nadia Adams",
            pickupAddress = "32 Palm St, Tafelsig",
        ...
        TripBooking(
            id = "dt3", commuterId = "u3", commuterName = "Yusuf Daniels",
            pickupAddress = "8 Westridge Rd, Mitchell's Plain",
            dropAddress   = "Athlone",
            date = LocalDate.now().plusDays(1),
            time = LocalTime.of(6, 45),
            passengers = 1,
            status = TripStatus.QUOTE_ACCEPTED,
            quotedAmount = 95.0,
            driverName   = "Taswill Heynes",
            vehicleInfo  = "Toyota HiAce — White",
            vehiclePlate = "CA 456 789",
        ...
        TripBooking(
            id = "dt4", commuterId = "u4", commuterName = "Fatima Jacobs",
            pickupAddress = "55 Lentegeur Ave, Mitchell's Plain",
            dropAddress   = "Somerset West Industrial",
        ...
        TripBooking(
            id = "dt5", commuterId = "u1", commuterName = "Tayla Hendricks",
            pickupAddress = "14 Sunrise Ave, Beacon Valley",
            dropAddress   = "Cape Town CBD, Adderley St",
        ...
        TripBooking(
            id = "dt6", commuterId = "u3", commuterName = "Yusuf Daniels",
            pickupAddress = "8 Westridge Rd, Mitchell's Plain",
            dropAddress   = "Athlone",
